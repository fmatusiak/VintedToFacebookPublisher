...
DROP TABLE IF EXISTS `facebook_photo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `facebook_photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_vinted_photo` varchar(255) DEFAULT NULL,
  `id_product` varchar(255) DEFAULT NULL,
  `fb_photo_id` varchar(255) DEFAULT NULL,
  `upload_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `vinted` (`id_vinted_photo`,`id_product`,`fb_photo_id`)
...
-- Dump completed on 2023-12-23 20:27:31
